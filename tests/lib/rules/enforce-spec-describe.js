...
const rule = require('../../../src/rules/enforce-spec-describe');
const parserOptions = {
    sourceType: 'module',
    ecmaVersion: 6,
    ecmaFeatures: {
...
ruleTester.run('enforce-spec-describe', rule, {
    valid: [
        {
            filename:
                'C:\\Projects\\SampleProject\\Source\\SampleProject.App\\js\\src\\modules\\sampleModule\\component\\component.jsx',
            options: [{ topLevelDir }],
            code: `
describe(() => {
...
`,
        ...
        {
            filename:
                'C:\\Projects\\SampleProject\\Source\\SampleProject.App\\js\\src\\modules\\sampleModule\\component\\component.spec.jsx',
            code: `
...
`,
        ...
        {
            filename:
                '/some/dir/SampleProject/Source/SampleProject.App/js/src/modules/sampleModule/component/component.jsx',
            code: `
describe(() => {
...
`,
        ...
        {
            filename:
                '/some/dir/SampleProject/Source/SampleProject.App/js/src/modules/sampleModule/component/component.spec.jsx',
            code: `
describe('src/modules/sampleModule/component/component', () => {
...
`,
            errors: [
                {
                    message:
                        'First argument of describe() needs to be path to tested file, ' +
